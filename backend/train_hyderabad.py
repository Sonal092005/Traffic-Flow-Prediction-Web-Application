...
DATA_PATH = os.path.join(PROJECT_ROOT, "data", "hyderabad_traffic_dataset_lstm.csv")
...
# ===============================
# Save Model & Scalers for Hyderabad
# ===============================
joblib.dump(scaler_X, os.path.join(MODEL_DIR, "scaler_X_hyderabad.pkl"))
joblib.dump(scaler_y, os.path.join(MODEL_DIR, "scaler_y_hyderabad.pkl"))
torch.save(model.state_dict(), os.path.join(MODEL_DIR, "traffic_lstm_hyderabad.pth"))

print("✅ Hyderabad model training completed successfully.")
print("✅ Model files saved with '_hyderabad' suffix.")
