...
DATA_PATH = os.path.join(PROJECT_ROOT, "data", "kalaburagi_traffic_dataset_lstm.csv")
...
# ===============================
# Save Model & Scalers for Kalaburagi
# ===============================
joblib.dump(scaler_X, os.path.join(MODEL_DIR, "scaler_X_kalaburagi.pkl"))
joblib.dump(scaler_y, os.path.join(MODEL_DIR, "scaler_y_kalaburagi.pkl"))
torch.save(model.state_dict(), os.path.join(MODEL_DIR, "traffic_lstm_kalaburagi.pth"))

print("✅ Kalaburagi model training completed successfully.")
print("✅ Model files saved with '_kalaburagi' suffix.")
