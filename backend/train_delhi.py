...
DATA_PATH = os.path.join(PROJECT_ROOT, "data", "delhi_traffic_dataset_lstm.csv")
...
# ===============================
# Save Model & Scalers for Delhi
# ===============================
joblib.dump(scaler_X, os.path.join(MODEL_DIR, "scaler_X_delhi.pkl"))
joblib.dump(scaler_y, os.path.join(MODEL_DIR, "scaler_y_delhi.pkl"))
torch.save(model.state_dict(), os.path.join(MODEL_DIR, "traffic_lstm_delhi.pth"))

print("✅ Delhi model training completed successfully.")
print("✅ Model files saved with '_delhi' suffix.")
