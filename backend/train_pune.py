...
DATA_PATH = os.path.join(PROJECT_ROOT, "data", "pune_traffic_dataset_lstm.csv")
...
# ===============================
# Save Model & Scalers for Pune
# ===============================
joblib.dump(scaler_X, os.path.join(MODEL_DIR, "scaler_X_pune.pkl"))
joblib.dump(scaler_y, os.path.join(MODEL_DIR, "scaler_y_pune.pkl"))
torch.save(model.state_dict(), os.path.join(MODEL_DIR, "traffic_lstm_pune.pth"))

print("✅ Pune model training completed successfully.")
print("✅ Model files saved with '_pune' suffix.")
