...
DATA_PATH = os.path.join(PROJECT_ROOT, "data", "kolkata_traffic_dataset_lstm.csv")
...
# ===============================
# Save Model & Scalers for Kolkata
# ===============================
joblib.dump(scaler_X, os.path.join(MODEL_DIR, "scaler_X_kolkata.pkl"))
joblib.dump(scaler_y, os.path.join(MODEL_DIR, "scaler_y_kolkata.pkl"))
torch.save(model.state_dict(), os.path.join(MODEL_DIR, "traffic_lstm_kolkata.pth"))

print("✅ Kolkata model training completed successfully.")
print("✅ Model files saved with '_kolkata' suffix.")
